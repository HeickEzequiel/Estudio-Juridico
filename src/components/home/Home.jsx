  ...
  return (
    <div className="min-w-min min-h-max overflow-hidden text-black">
        <Nav/>
          ...
          <div class="tooltip [--placement:right] [--trigger:click] [--prevent-popper:true] lg:relative lg:border-double lg:border-4 lg:border-violet-500 lg:shadow-2xl lg:h-52 lg:w-40% lg:left-20 lg:top-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700 hover:bg-pink-300">
            <div class="tooltip-toggle">
              ...
              <div class="tooltip-content tooltip-shown:opacity-100 tooltip-shown:visible left-95% ml-14" role="popover">
                <div class="tooltip-body bg-violet-400 w-10%   rounded-lg p-4 ">
                  <span class="text-lg font-bold">Derecho de Familia y Sucesiones</span>
                  <p className="lg:relative lg:p-4 lg:font-cursiva lg:font lg:text-xl">En el área de Derecho de Familia y Sucesiones, brindamos asesoría y acompañamiento en los aspectos legales que afectan el núcleo familiar y la planificación del patrimonio. Nos especializamos en resolver conflictos de forma justa y eficiente, siempre priorizando la protección de los derechos y el bienestar de cada miembro de la familia.
                    ...
                    Comprendemos la importancia de estos asuntos y ofrecemos un enfoque personalizado y sensible que busca soluciones adecuadas a tus necesidades y circunstancias particulares. Contamos con un equipo experto en Derecho de Familia y Sucesiones para ayudarte en cada paso del proceso.
                  </p>
                </div>
              </div>
          ...
          <div className=" relative">
          <div class="tooltip [--placement:right] [--trigger:click] [--prevent-popper:true] lg:relative lg:border-double lg:border-4 lg:border-violet-500 lg:shadow-2xl lg:h-52 lg:w-40% lg:left-20 lg:top-24 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700 hover:bg-pink-300">
            <div class="tooltip-toggle">
              ...
              <div class="tooltip-content tooltip-shown:opacity-100 tooltip-shown:visible left-95% ml-14" role="popover">
                <div class="tooltip-body bg-violet-400 w-10%   rounded-lg p-4 ">
                  ...
                  <p className="lg:relative lg:p-4 lg:font-cursiva lg:font lg:text-xl">En nuestra área de Derecho Laboral, ofrecemos asesoramiento integral tanto a empleados como a empleadores, brindando soluciones efectivas en el ámbito laboral. Nos dedicamos a proteger los derechos laborales y a promover condiciones de trabajo justas, proporcionando asistencia en la interpretación y aplicación de la normativa laboral vigente.
                    ...
                    Nos comprometemos a ofrecer un trato cercano y profesional, adaptándonos a cada situación para garantizar una solución eficiente y justa. Conocemos la importancia de cada caso laboral y estamos aquí para brindar el apoyo y la experiencia legal que necesitas.
                  </p>
                </div>
              </div>
          ...
          <div class="tooltip [--placement:right] [--trigger:click] [--prevent-popper:true] lg:relative lg:border-double lg:border-4 lg:border-violet-500 lg:shadow-2xl lg:h-52 lg:w-40% lg:left-20 lg:top-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700 hover:bg-pink-300">
            <div class="tooltip-toggle">
              ...
              <div class="tooltip-content tooltip-shown:opacity-100 tooltip-shown:visible left-95% ml-14" role="popover">
                <div class="tooltip-body bg-violet-400 w-10%   rounded-lg p-4 ">
                  ...
                  <p className="lg:relative lg:p-4 lg:font-cursiva lg:font lg:text-xl">En el área de Derecho Civil especializado en Daños y Perjuicios, ofrecemos asesoría legal para reclamar y proteger los derechos de quienes han sufrido pérdidas o perjuicios como resultado de acciones u omisiones de terceros. Nuestro equipo de expertos se encarga de evaluar cada situación de manera exhaustiva, identificando la responsabilidad y garantizando la reparación del daño sufrido.
                    ...
                    Estamos aquí para ayudarte a entender tus derechos y a guiarte en cada paso del proceso legal, para que puedas obtener la justicia y la reparación que mereces.
                  </p>
                </div>
              </div>
